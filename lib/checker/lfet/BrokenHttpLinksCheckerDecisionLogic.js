    ...
    while (!exit) {
      ...
      if (ruleGroup === 1 /* step 1 - 1 */) {
        if (iface.isIgnoreLocalhostCheck(model)) {
          ...
          this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 1 / 16 - ${JSON.stringify(model)}`)
          ...
          if (iface.isCheckIfLocalhost(cav.CHECK_IF_LOCALHOST_LOCALHOST, model) /* localhost - \/\/localhost */) {
            ...
            this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 2 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 3 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 4 / 16 - ${JSON.stringify(model)}`)
        ...
        if (iface.isIgnoreIpAddressCheck(model)) {
          ...
          this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 5 / 16 - ${JSON.stringify(model)}`)
          ...
          if (iface.isCheckIfIpAddress(model)) {
            ...
            this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 6 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 7 / 16 - ${JSON.stringify(model)}`)
        ...
        this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 8 / 16 - ${JSON.stringify(model)}`)
        ...
        if (iface.isCheckHeadHttpStatusCodeInConfiguredSuccessRange_SUCCESS(model)) {
          ...
          this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 9 / 16 - ${JSON.stringify(model)}`)
          ...
          if (iface.isCheckHeadHttpStatusCodeInRedirectRange(cav.CHECK_HEAD_HTTP_STATUS_CODE_IN_REDIRECT_RANGE_30_X, model) /* 30x - [301:308] */) {
            if (iface.isCheckIfHeaderContainsLocation(model)) {
              ...
              this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 10 / 16 - ${JSON.stringify(model)}`)
              ...
              this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 11 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 12 / 16 - ${JSON.stringify(model)}`)
        ...
        if (iface.isCheckGetHttpStatusCodeInConfiguredRanges_SUCCESS(model)) {
          ...
          this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 13 / 16 - ${JSON.stringify(model)}`)
          ...
          this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 14 / 16 - ${JSON.stringify(model)}`)
          ...
          this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 15 / 16 - ${JSON.stringify(model)}`)
          ...
          this.logger.trace(`BrokenHttpLinksChecker - 20240814.234218 - 16 / 16 - ${JSON.stringify(model)}`)
