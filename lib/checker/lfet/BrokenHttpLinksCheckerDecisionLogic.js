    ...
    while (!exit) {
      ...
      if (ruleGroup === 1 /* step 1 - 1 */) {
        if (iface.isIgnoreLocalhostCheck(model)) {
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 1 / 16 - ${JSON.stringify(model)}`)
          ...
          if (iface.isCheckIfLocalhost(cav.CHECK_IF_LOCALHOST_LOCALHOST, model) /* localhost - \/\/localhost */) {
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 2 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 3 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 4 / 16 - ${JSON.stringify(model)}`)
        ...
        if (iface.isIgnoreIpAddressCheck(model)) {
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 5 / 16 - ${JSON.stringify(model)}`)
          ...
          if (iface.isCheckIfIpAddress(model)) {
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 6 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 7 / 16 - ${JSON.stringify(model)}`)
        ...
        this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 8 / 16 - ${JSON.stringify(model)}`)
        ...
        if (iface.isCheckHttpStatusCodeInConfiguredSuccessRange_SUCCESS(model)) {
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 9 / 16 - ${JSON.stringify(model)}`)
          ...
          if (iface.isCheckHttpStatusCodeInRedirectRange(cav.CHECK_HTTP_STATUS_CODE_IN_REDIRECT_RANGE_30_X, model) /* 30x - [301:308] */) {
            if (iface.isCheckIfHeaderContainsLocation(model)) {
              ...
              this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 10 / 16 - ${JSON.stringify(model)}`)
              ...
              this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 11 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 12 / 16 - ${JSON.stringify(model)}`)
        ...
        if (iface.isCheckHttpStatusCodeInConfiguredSuccessRange_SUCCESS(model)) {
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 13 / 16 - ${JSON.stringify(model)}`)
          ...
          if (iface.isCheckHttpStatusCodeInConfiguredWarningRange_WARN(model)) {
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 14 / 16 - ${JSON.stringify(model)}`)
            ...
            if (iface.isCheckHttpStatusCodeInConfiguredErrorRange_ERROR(model)) {
              ...
              this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 15 / 16 - ${JSON.stringify(model)}`)
              ...
              this.logger.log(`BrokenHttpLinksChecker - 20240605.122711 - 16 / 16 - ${JSON.stringify(model)}`)
