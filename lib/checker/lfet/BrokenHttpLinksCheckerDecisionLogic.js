    ...
    while (!exit) {
      ...
      if (ruleGroup === 1 /* step 1 - 1 */) {
        if (iface.isIgnoreLocalhostCheck(model)) {
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 1 / 16 - ${JSON.stringify(model)}`)
          ...
          if (iface.isCheckIfLocalhost(cav.CHECK_IF_LOCALHOST_LOCALHOST, model) /* localhost - \/\/localhost */) {
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 2 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 3 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 4 / 16 - ${JSON.stringify(model)}`)
        ...
        if (iface.isIgnoreIpAddressCheck(model)) {
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 5 / 16 - ${JSON.stringify(model)}`)
          ...
          if (iface.isCheckIfIpAddress(model)) {
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 6 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 7 / 16 - ${JSON.stringify(model)}`)
        ...
        this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 8 / 16 - ${JSON.stringify(model)}`)
        ...
        if (iface.isCheckHeadHttpStatusCodeInConfiguredSuccessRange_SUCCESS(model)) {
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 9 / 16 - ${JSON.stringify(model)}`)
          ...
          if (iface.isCheckHeadHttpStatusCodeInRedirectRange(cav.CHECK_HEAD_HTTP_STATUS_CODE_IN_REDIRECT_RANGE_30_X, model) /* 30x - [301:308] */) {
            if (iface.isCheckIfHeaderContainsLocation(model)) {
              ...
              this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 10 / 16 - ${JSON.stringify(model)}`)
              ...
              this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 11 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 12 / 16 - ${JSON.stringify(model)}`)
        ...
        if (iface.isCheckGetHttpStatusCodeInConfiguredRanges_SUCCESS(model)) {
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 13 / 16 - ${JSON.stringify(model)}`)
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 14 / 16 - ${JSON.stringify(model)}`)
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 15 / 16 - ${JSON.stringify(model)}`)
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240703.122209 - 16 / 16 - ${JSON.stringify(model)}`)
