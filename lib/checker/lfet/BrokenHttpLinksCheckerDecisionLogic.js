        ...
        exit = true
            ...
            if (ruleGroup === 1 /* step 1 - 1 */) {
                if (iface.isIgnoreLocalhostCheck(model)) {
                    ...
                    console.log(`BrokenHttpLinksChecker - 20240313.075011 - 1 / 16 - ${JSON.stringify(model)}`)
                    ...
                    if (iface.isCheckIfLocalhost(cav.CheckIfLocalhost_LOCALHOST, model) /* localhost - \/\/localhost */) {
                        ...
                        console.log(`BrokenHttpLinksChecker - 20240313.075011 - 2 / 16 - ${JSON.stringify(model)}`)
                        ...
                        console.log(`BrokenHttpLinksChecker - 20240313.075011 - 3 / 16 - ${JSON.stringify(model)}`)
                        ...
                        console.log(`BrokenHttpLinksChecker - 20240313.075011 - 4 / 16 - ${JSON.stringify(model)}`)
                ...
                if (iface.isIgnoreIpAddressCheck(model)) {
                    ...
                    console.log(`BrokenHttpLinksChecker - 20240313.075011 - 5 / 16 - ${JSON.stringify(model)}`)
                    ...
                    if (iface.isCheckIfIpAddress(model)) {
                        ...
                        console.log(`BrokenHttpLinksChecker - 20240313.075011 - 6 / 16 - ${JSON.stringify(model)}`)
                        ...
                        console.log(`BrokenHttpLinksChecker - 20240313.075011 - 7 / 16 - ${JSON.stringify(model)}`)
                ...
                console.log(`BrokenHttpLinksChecker - 20240313.075011 - 8 / 16 - ${JSON.stringify(model)}`)
                ...
                if (iface.isCheckHttpStatusCodeInConfiguredSuccessRange_SUCCESS(model)) {
                    ...
                    console.log(`BrokenHttpLinksChecker - 20240313.075011 - 9 / 16 - ${JSON.stringify(model)}`)
                    ...
                    if (iface.isCheckHttpStatusCodeInRedirectRange_30X(model)) {
                        if (iface.isCheckIfHeaderContainsLocation(model)) {
                            ...
                            console.log(`BrokenHttpLinksChecker - 20240313.075011 - 10 / 16 - ${JSON.stringify(model)}`)
                            ...
                            console.log(`BrokenHttpLinksChecker - 20240313.075011 - 11 / 16 - ${JSON.stringify(model)}`)
                        ...
                        console.log(`BrokenHttpLinksChecker - 20240313.075011 - 12 / 16 - ${JSON.stringify(model)}`)
                ...
                if (iface.isCheckHttpStatusCodeInConfiguredSuccessRange_SUCCESS(model)) {
                    ...
                    console.log(`BrokenHttpLinksChecker - 20240313.075011 - 13 / 16 - ${JSON.stringify(model)}`)
                    ...
                    if (iface.isCheckHttpStatusCodeInConfiguredWarningRange_WARN(model)) {
                        ...
                        console.log(`BrokenHttpLinksChecker - 20240313.075011 - 14 / 16 - ${JSON.stringify(model)}`)
                        ...
                        if (iface.isCheckHttpStatusCodeInConfiguredErrorRange_ERROR(model)) {
                            ...
                            console.log(`BrokenHttpLinksChecker - 20240313.075011 - 15 / 16 - ${JSON.stringify(model)}`)
                            ...
                            console.log(`BrokenHttpLinksChecker - 20240313.075011 - 16 / 16 - ${JSON.stringify(model)}`)
