    ...
    while (!exit) {
      ...
      if (ruleGroup === 1 /* step 1 - 1 */) {
        if (iface.isIgnoreLocalhostCheck(model)) {
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 1 / 16 - ${JSON.stringify(model)}`)
          ...
          if (iface.isCheckIfLocalhost(cav.CHECK_IF_LOCALHOST_LOCALHOST, model) /* localhost - \/\/localhost */) {
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 2 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 3 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 4 / 16 - ${JSON.stringify(model)}`)
        ...
        if (iface.isIgnoreIpAddressCheck(model)) {
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 5 / 16 - ${JSON.stringify(model)}`)
          ...
          if (iface.isCheckIfIpAddress(model)) {
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 6 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 7 / 16 - ${JSON.stringify(model)}`)
        ...
        this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 8 / 16 - ${JSON.stringify(model)}`)
        ...
        if (iface.isCheckHEADHttpStatusCodeInConfiguredSuccessRange_SUCCESS(model)) {
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 9 / 16 - ${JSON.stringify(model)}`)
          ...
          if (iface.isCheckHEADHttpStatusCodeInRedirectRange_30X(model)) {
            if (iface.isCheckIfHeaderContainsLocation(model)) {
              // Rule R10 ---->

              this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 10 / 16 - ${JSON.stringify(model)}`)
              ...
              this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 11 / 16 - ${JSON.stringify(model)}`)
            ...
            this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 12 / 16 - ${JSON.stringify(model)}`)
        ...
        if (iface.isCheckGETHttpStatusCodeInConfiguredRanges_SUCCESS(model)) {
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 13 / 16 - ${JSON.stringify(model)}`)
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 14 / 16 - ${JSON.stringify(model)}`)
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 15 / 16 - ${JSON.stringify(model)}`)
          ...
          this.logger.log(`BrokenHttpLinksChecker - 20240703.113825 - 16 / 16 - ${JSON.stringify(model)}`)
