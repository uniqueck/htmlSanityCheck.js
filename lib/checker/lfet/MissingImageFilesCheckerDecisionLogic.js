  ...
  execute (/* IMissingImageFilesChecker */ iface, model) {
    ...
    if (iface.isImageSrcIsDataUri(model)) {
      if (iface.isImageSrcContainsData(model)) {
        ...
        this.logger.trace(`MissingImageFilesChecker - 20240703.195150 - 1 / 5 - ${JSON.stringify(model)}`)
        ...
        this.logger.trace(`MissingImageFilesChecker - 20240703.195150 - 2 / 5 - ${JSON.stringify(model)}`)
      ...
      if (iface.isImageSrcIsRemoteUri(model)) {
        ...
        this.logger.trace(`MissingImageFilesChecker - 20240703.195150 - 3 / 5 - ${JSON.stringify(model)}`)
        ...
        if (iface.isLocalImageFileExists(model)) {
          ...
          this.logger.trace(`MissingImageFilesChecker - 20240703.195150 - 4 / 5 - ${JSON.stringify(model)}`)
          ...
          this.logger.trace(`MissingImageFilesChecker - 20240703.195150 - 5 / 5 - ${JSON.stringify(model)}`)
