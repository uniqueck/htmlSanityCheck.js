  ...
  execute (/* IMissingImageFilesChecker */ iface, model) {
    ...
    if (iface.isImageSrcIsDataUri(model)) {
      if (iface.isImageSrcContainsData(model)) {
        ...
        this.logger.log(`MissingImageFilesChecker - 20240703.122209 - 1 / 5 - ${JSON.stringify(model)}`)
        ...
        this.logger.log(`MissingImageFilesChecker - 20240703.122209 - 2 / 5 - ${JSON.stringify(model)}`)
      ...
      if (iface.isImageSrcIsRemoteUri(model)) {
        ...
        this.logger.log(`MissingImageFilesChecker - 20240703.122209 - 3 / 5 - ${JSON.stringify(model)}`)
        ...
        if (iface.isLocalImageFileExists(model)) {
          ...
          this.logger.log(`MissingImageFilesChecker - 20240703.122209 - 4 / 5 - ${JSON.stringify(model)}`)
          ...
          this.logger.log(`MissingImageFilesChecker - 20240703.122209 - 5 / 5 - ${JSON.stringify(model)}`)
