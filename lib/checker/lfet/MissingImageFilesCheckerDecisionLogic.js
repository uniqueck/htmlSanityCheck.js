...
// Prolog Standard <----
        ...
        if (iface.isImageSrcIsDataUri(model)) {
            if (iface.isImageSrcContainsData(model)) {
                ...
                console.log(`MissingImageFilesChecker - 20240313.075011 - 1 / 5 - ${JSON.stringify(model)}`)
                ...
                console.log(`MissingImageFilesChecker - 20240313.075011 - 2 / 5 - ${JSON.stringify(model)}`)
            ...
            if (iface.isImageSrcIsRemoteUri(model)) {
                ...
                console.log(`MissingImageFilesChecker - 20240313.075011 - 3 / 5 - ${JSON.stringify(model)}`)
                ...
                if (iface.isLocalImageFileExists(model)) {
                    ...
                    console.log(`MissingImageFilesChecker - 20240313.075011 - 4 / 5 - ${JSON.stringify(model)}`)
                    ...
                    console.log(`MissingImageFilesChecker - 20240313.075011 - 5 / 5 - ${JSON.stringify(model)}`)
