  ...
  execute (/* IMissingImageFilesChecker */ iface, model) {
    ...
    if (iface.isImageSrcIsDataUri(model)) {
      if (iface.isImageSrcContainsData(model)) {
        ...
        this.logger.log(`MissingImageFilesChecker - 20240605.122711 - 1 / 5 - ${JSON.stringify(model)}`)
        ...
        this.logger.log(`MissingImageFilesChecker - 20240605.122711 - 2 / 5 - ${JSON.stringify(model)}`)
      ...
      if (iface.isImageSrcIsRemoteUri(model)) {
        ...
        this.logger.log(`MissingImageFilesChecker - 20240605.122711 - 3 / 5 - ${JSON.stringify(model)}`)
        ...
        if (iface.isLocalImageFileExists(model)) {
          ...
          this.logger.log(`MissingImageFilesChecker - 20240605.122711 - 4 / 5 - ${JSON.stringify(model)}`)
          ...
          this.logger.log(`MissingImageFilesChecker - 20240605.122711 - 5 / 5 - ${JSON.stringify(model)}`)
